...
public class HttpStatusService {
    ...
    public HttpStatusService() {
        ...
        map.put(HttpStatusCode.REQUEST_ENTITY_TOO_LARGE, new HttpStatus(413, "Request Entity Too Large"));
        ...
        map.put(HttpStatusCode.UNPROCESSABLE_ENTITY, new HttpStatus(422, "Unprocessable Entity"));
    }
